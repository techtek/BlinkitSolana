...
:set   
	...
	:: Get the Solana Wallet address from solanawallet.txt 
	...
	:: JSON request body 
    set jsonbody='{\"jsonrpc\":\"2.0\", \"id\":1, \"method\":\"getBalance\", \"params\":[\"%solanawallet%\"]}'
...
:: let the user know the program is running by displaying the text:  
	...
	:: Display the SOL balance and make the SOL balance readable 	
